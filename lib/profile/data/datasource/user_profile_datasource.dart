...
abstract class UserProfileDataSource {
  ...
  Future<ActivityListModel> getUserActivityNew({required int pageNumber, required int pageSize});
  Future<ActivityListModel> getVisitedUserActivity({required String userId, required int pageNumber, required int pageSize});
}
