                              ...
                              activeTab == 1
                                  ? Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        if (theUser?.profile?.aboutMe.length >
                                            0)
                                          SizedBox(height: 20),
                                        if (theUser?.profile?.aboutMe.length >
                                            0)
                                        ...
                                        Text(
                                          theUser?.profile?.aboutMe.length >
                                                      150 &&
                                                  showFullBio
                                              ? theUser?.profile?.aboutMe
                                                      .substring(0, 150) +
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            if (theUser!.userDownlines!.length >
                                                0)
                                              TransparentButtonNew(
                                                title: 'View all',
                                                action: () {},
                                        ...
                                        SingleChildScrollView(
                                          ...
                                          child: Row(
                                              children: theUser?.userDownlines!
                                                      .map((e) {
                                                    return GestureDetector(
                                                      onTap: () {},
                                                      child: Padding(
...
class PostsWidget extends StatefulWidget {
  ...
  PostsWidget({super.key, this.isVideo = false, this.medias});
...
class _PostsWidgetState extends State<PostsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: SizedBox(
        width: double.infinity,
        child: widget.medias!.isNotEmpty
            ? Wrap(
                runSpacing: 10,
