...
@RoutePage()
class ProfileCarouselScreen extends ConsumerStatefulWidget {
  const ProfileCarouselScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ProfileCarouselScreenState();
}

class _ProfileCarouselScreenState extends ConsumerState<ProfileCarouselScreen> {
