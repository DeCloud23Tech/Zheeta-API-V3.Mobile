...
class BioDataScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _BioDataScreenState();
}
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 40),
                InputField(
                  validator: (data) => userProfileViewModel.validateFirstName(),
                  onChanged: (value) => userProfileViewModel.setFirstName(value),
                  hintText: 'First Name',
                ),
                InputField(
                  validator: (data) => userProfileViewModel.validateLastName(),
                  onChanged: (value) => userProfileViewModel.setLastName(value),
                  hintText: 'Last Name',
                ),
                Theme(
                ...
                SizedBox(
                  ...
                  child: PrimaryButton(
                    title: 'Continue',
                    action: () {
                      if (formKey.currentState!.validate() && userProfileViewModel.isValidGender()) {
