...
//
//   const ProfileBoostScreen({Key? key, required this.subscriptionPlan})
//       : super(key: key);
//
//   @override
...
//   late ChargesViewModel chargesViewModel;
...
//     chargesViewModel = locator<ChargesViewModel>();
//     loadCountryData();
//     // _fetchMatchedProfileBoostCount();
//     // chargesViewModel.fetchAllCharges();
...
//   }
//
//   Future<void> _fetchMatchedProfileBoostCount() async {
//     await userProfileViewModel.getMatchedProfileBoostCount(context);
//   }
//
//   void _updateCost() {}
//
...
//                         ),
//                         Text(
//                           'Total Matched Users: ${userProfileViewModel
//                               .matchedProfileBoostCount}',
//                           style: TextStyle(
//                             fontSize: 16,
//                             fontWeight: FontWeight.w400,
//                             color: AppColors.primaryDark,
...
//                                 }
//                                 widget
//                                     .onSelectionChanged(_selectedMedias);
//                               },
//                             );
//                           },
//                           child: Stack(
...
// }
//
// Future userPostsBottomSheet(BuildContext context,
...
//   void initState() {
//     super.initState();
//     replacedImages = List<File?>.filled(widget.carouselImageUrls?.length ?? 0, null);
//   }
//
...
//         itemCount: 6,
//         itemBuilder: (context, index) {
//           if (index < (widget.carouselImageUrls?.length ?? 0)) {
...
//                           : Image.network(
//                         widget.carouselImageUrls![index].carouselPhotoUrl,
//                         fit: BoxFit.cover,
//                       ),
//                     ),
//                   ),
