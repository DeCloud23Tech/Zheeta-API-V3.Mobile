              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      direction: Axis.horizontal,
                      children: vm.interestsList?.data
                              .map((value) {
                    ...
                    DropdownInputField(
                      ...
                      onChanged: (value) => vm.setOccupation(value!),
                    ...
                    InputField(
                      ...
                      onChanged: (value) => vm.setAbout(value),
                      validator: (value) => isValidInput(value),
                    ),
                    SizedBox(height: 10),
                    Text(
                    ...
                    InputField(
                      ...
                      onChanged: (value) => vm.setTagline(value),
                      validator: (value) => isValidInput(value),
                    ),
                    SizedBox(height: 23),
                    SizedBox(
