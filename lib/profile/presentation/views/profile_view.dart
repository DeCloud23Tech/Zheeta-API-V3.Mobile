...
class _ProfileScreenState extends State<ProfileViewScreen> {
  ...
  ViewProfileModel? viewProfileData;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      viewProfileData = await userProfileViewModel.visitUserProfile(
                      ...
                      activeTab == 1
                          ? Column(
                              ...
                              children: [
                                ...
                                Text(
                                  theUser?.profile?.aboutMe.length > 150 &&
                                          showFullBio
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    if (theUser!.userDownlines!.length > 0)
