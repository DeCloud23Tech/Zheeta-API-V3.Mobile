...
import 'package:zheeta/features/payment_and_subscriptions/presentation/views/subscription_and_charges/subscription_details_screen.dart';
  ...
  Widget _buildBottomNavigationBar() {
    ...
    return Padding(
      ...
      child: BlocBuilder<ProfileCubit, ProfileState>(
        builder: (context, state) {
          final activePlan = state.profile?.data?.userSubscription?.name.trim();
          return Visibility(
