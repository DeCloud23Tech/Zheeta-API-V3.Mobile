...
_$BoostInsightModelImpl _$$BoostInsightModelImplFromJson(
        Map<String, dynamic> json) =>
    _$BoostInsightModelImpl(
...
Map<String, dynamic> _$$BoostInsightModelImplToJson(
        _$BoostInsightModelImpl instance) =>
    <String, dynamic>{
