...
class SendFriendRequestProcessing extends FriendsState {}

class SendFriendRequestSuccess extends FriendsState {}

class SendFriendRequestError extends FriendsState {
  final String message;
  const SendFriendRequestError(this.message);

  @override
  List<Object> get props => [message];
}

class BulkFriendRequestProcessed extends FriendsState {}
