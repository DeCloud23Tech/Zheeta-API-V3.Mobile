...
//     final total =
//         (counters.regularCount + counters.silverCount + counters.goldCount)
//             .toDouble();
//     return total == 0
//         ? [0.0, 0.0]
//         : [counters.silverCount / total, counters.goldCount / total];
//   }
//
//   @override
//   void dispose() {
...
//       child: Row(
//         children: [
//           _paginationButton('Prev', Icons.arrow_circle_left_rounded,
//               decrement: true),
//           const Spacer(),
//           _paginationButton('Next', Icons.arrow_circle_right_rounded,
//               decrement: false),
//         ],
//       ),
//     );
//   }
//
//   Widget _paginationButton(String text, IconData icon,
...
//           paginationParams.value = paginationParams.value
//               .copyWith(pageNo: paginationParams.value.pageNo - 1);
//           _fetchTransactions();
//         } else if (!decrement) {
//           paginationParams.value = paginationParams.value
//               .copyWith(pageNo: paginationParams.value.pageNo + 1);
...
//         transactions.reversed.toList().take(5).toList();
//
//     return Container(
//       padding: const EdgeInsets.symmetric(horizontal: 4),
