...
class RedeemGiftSuccessScreen extends StatefulWidget {
  ...
  @override
  RedeemGiftSuccessScreenState createState() => RedeemGiftSuccessScreenState();
}

class RedeemGiftSuccessScreenState extends State<RedeemGiftSuccessScreen>
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        automaticallyImplyLeading:
            false, // This prevents showing the back button
        elevation: 0.0,
        title: Text(
