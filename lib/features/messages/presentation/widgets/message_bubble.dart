        ...
        if (!isMe)
          CustomPaint(
            painter: TrianglePainter(
                isMe ? AppColors.primaryDark : AppColors.white, isMe),
          ),
      ],
    );
  }
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              if (message
                  .mediaUrl.isNotEmpty) // If the message has an image URL
                ClipRRect(
                  borderRadius: BorderRadius.circular(16.0),
                  child: Image.network(
                    message.mediaUrl, // Assuming the image is hosted on a URL
                    width: 169.0,
                    height: 209.0,
                    fit: BoxFit.cover,
                  ),
