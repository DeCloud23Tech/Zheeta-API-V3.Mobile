...
_$BuddyEventVerificationImpl _$$BuddyEventVerificationImplFromJson(
        Map<String, dynamic> json) =>
    _$BuddyEventVerificationImpl(
...
Map<String, dynamic> _$$BuddyEventVerificationImplToJson(
        _$BuddyEventVerificationImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
