...
_$BuddyEventMessageImpl _$$BuddyEventMessageImplFromJson(
        Map<String, dynamic> json) =>
    _$BuddyEventMessageImpl(
...
Map<String, dynamic> _$$BuddyEventMessageImplToJson(
        _$BuddyEventMessageImpl instance) =>
    <String, dynamic>{
