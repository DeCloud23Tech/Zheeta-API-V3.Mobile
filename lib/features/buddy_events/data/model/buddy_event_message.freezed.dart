...
BuddyEventMessage _$BuddyEventMessageFromJson(Map<String, dynamic> json) {
  return _BuddyEventMessage.fromJson(json);
}

/// @nodoc
mixin _$BuddyEventMessage {
  String get buddyEventId => throw _privateConstructorUsedError;
  String get buddyEventCreatorId => throw _privateConstructorUsedError;
  String get userId => throw _privateConstructorUsedError;
  String get username => throw _privateConstructorUsedError;
  String get message => throw _privateConstructorUsedError;
  String? get messageParentId => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $BuddyEventMessageCopyWith<$Res> {
  factory $BuddyEventMessageCopyWith(
          BuddyEventMessage value, $Res Function(BuddyEventMessage) then) =
      _$BuddyEventMessageCopyWithImpl<$Res, BuddyEventMessage>;
  @useResult
  $Res call(
      {String buddyEventId,
...
/// @nodoc
class _$BuddyEventMessageCopyWithImpl<$Res, $Val extends BuddyEventMessage>
    implements $BuddyEventMessageCopyWith<$Res> {
  _$BuddyEventMessageCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BuddyEventMessageImplCopyWith<$Res>
    implements $BuddyEventMessageCopyWith<$Res> {
  factory _$$BuddyEventMessageImplCopyWith(_$BuddyEventMessageImpl value,
          $Res Function(_$BuddyEventMessageImpl) then) =
      __$$BuddyEventMessageImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String buddyEventId,
...
/// @nodoc
class __$$BuddyEventMessageImplCopyWithImpl<$Res>
    extends _$BuddyEventMessageCopyWithImpl<$Res, _$BuddyEventMessageImpl>
    implements _$$BuddyEventMessageImplCopyWith<$Res> {
  __$$BuddyEventMessageImplCopyWithImpl(_$BuddyEventMessageImpl _value,
      $Res Function(_$BuddyEventMessageImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BuddyEventMessageImpl(
      buddyEventId: null == buddyEventId
          ? _value.buddyEventId
          : buddyEventId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$BuddyEventMessageImpl implements _BuddyEventMessage {
  const _$BuddyEventMessageImpl(
  ...
  factory _$BuddyEventMessageImpl.fromJson(Map<String, dynamic> json) =>
      _$$BuddyEventMessageImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BuddyEventMessageImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BuddyEventMessageImplCopyWith<_$BuddyEventMessageImpl> get copyWith =>
      __$$BuddyEventMessageImplCopyWithImpl<_$BuddyEventMessageImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BuddyEventMessageImplToJson(
      this,
    );
  }
}

abstract class _BuddyEventMessage implements BuddyEventMessage {
  const factory _BuddyEventMessage(
      {required final String buddyEventId,
      required final String buddyEventCreatorId,
      ...
      required final DateTime createdDate}) = _$BuddyEventMessageImpl;

  factory _BuddyEventMessage.fromJson(Map<String, dynamic> json) =
      _$BuddyEventMessageImpl.fromJson;
