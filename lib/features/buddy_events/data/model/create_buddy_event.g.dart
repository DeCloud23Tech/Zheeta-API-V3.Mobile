...
_$CreateBuddyEventDataImpl _$$CreateBuddyEventDataImplFromJson(
        Map<String, dynamic> json) =>
    _$CreateBuddyEventDataImpl(
...
Map<String, dynamic> _$$CreateBuddyEventDataImplToJson(
        _$CreateBuddyEventDataImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
