...
_$BuddySearchResponseImpl _$$BuddySearchResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$BuddySearchResponseImpl(
...
Map<String, dynamic> _$$BuddySearchResponseImplToJson(
        _$BuddySearchResponseImpl instance) =>
    <String, dynamic>{
...
_$BuddyEventSearchImpl _$$BuddyEventSearchImplFromJson(
        Map<String, dynamic> json) =>
    _$BuddyEventSearchImpl(
...
Map<String, dynamic> _$$BuddyEventSearchImplToJson(
        _$BuddyEventSearchImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
