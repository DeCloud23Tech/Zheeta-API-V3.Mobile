...
JoinedBuddyEvent _$JoinedBuddyEventFromJson(Map<String, dynamic> json) {
  return _JoinedBuddyEvent.fromJson(json);
}
...
/// @nodoc
abstract class $JoinedBuddyEventCopyWith<$Res> {
  factory $JoinedBuddyEventCopyWith(
          JoinedBuddyEvent value, $Res Function(JoinedBuddyEvent) then) =
      _$JoinedBuddyEventCopyWithImpl<$Res, JoinedBuddyEvent>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$JoinedBuddyEventCopyWithImpl<$Res, $Val extends JoinedBuddyEvent>
    implements $JoinedBuddyEventCopyWith<$Res> {
  _$JoinedBuddyEventCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$JoinedBuddyEventImplCopyWith<$Res>
    implements $JoinedBuddyEventCopyWith<$Res> {
  factory _$$JoinedBuddyEventImplCopyWith(_$JoinedBuddyEventImpl value,
          $Res Function(_$JoinedBuddyEventImpl) then) =
      __$$JoinedBuddyEventImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$JoinedBuddyEventImplCopyWithImpl<$Res>
    extends _$JoinedBuddyEventCopyWithImpl<$Res, _$JoinedBuddyEventImpl>
    implements _$$JoinedBuddyEventImplCopyWith<$Res> {
  __$$JoinedBuddyEventImplCopyWithImpl(_$JoinedBuddyEventImpl _value,
      $Res Function(_$JoinedBuddyEventImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$JoinedBuddyEventImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$JoinedBuddyEventImpl implements _JoinedBuddyEvent {
  const _$JoinedBuddyEventImpl(
      {required this.id,
      required this.title,
  ...
  factory _$JoinedBuddyEventImpl.fromJson(Map<String, dynamic> json) =>
      _$$JoinedBuddyEventImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$JoinedBuddyEventImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$JoinedBuddyEventImplCopyWith<_$JoinedBuddyEventImpl> get copyWith =>
      __$$JoinedBuddyEventImplCopyWithImpl<_$JoinedBuddyEventImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$JoinedBuddyEventImplToJson(
      this,
    );
  }
}

abstract class _JoinedBuddyEvent implements JoinedBuddyEvent {
  const factory _JoinedBuddyEvent(
      ...
      final double? eventParticipationCost}) = _$JoinedBuddyEventImpl;

  factory _JoinedBuddyEvent.fromJson(Map<String, dynamic> json) =
      _$JoinedBuddyEventImpl.fromJson;
