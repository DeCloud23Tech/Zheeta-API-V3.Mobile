                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text("Umbrella", style: TextStyle(color: grayscale, fontSize: 14, fontWeight: FontWeight.w400)),
                            SizedBox(height: 5),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Container(padding: EdgeInsets.all(10), height: 40, width: 40, decoration: BoxDecoration(color: white, borderRadius: BorderRadius.circular(100)), child: SvgPicture.asset(icon, width: 30, colorFilter: ColorFilter.mode(grey, BlendMode.srcIn))),
      ),
    );
  }
}
