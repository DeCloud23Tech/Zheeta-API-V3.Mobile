                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 10),
                            Text("Christine Doe", style: TextStyle(color: primaryDark, fontSize: 14, fontWeight: FontWeight.w400)),
                          ],
                        ),
                        SizedBox(width: MediaQuery.of(context).size.width * 0.3, height: 30, child: PrimaryButton(title: "View Profile", action: () {})),
                      ],
                    )),
              SizedBox(height: 100),
            ],
