...
BuddyEvent _$BuddyEventFromJson(Map<String, dynamic> json) {
  return _BuddyEvent.fromJson(json);
}
...
/// @nodoc
abstract class $BuddyEventCopyWith<$Res> {
  factory $BuddyEventCopyWith(
          BuddyEvent value, $Res Function(BuddyEvent) then) =
      _$BuddyEventCopyWithImpl<$Res, BuddyEvent>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$BuddyEventCopyWithImpl<$Res, $Val extends BuddyEvent>
    implements $BuddyEventCopyWith<$Res> {
  _$BuddyEventCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BuddyEventImplCopyWith<$Res>
    implements $BuddyEventCopyWith<$Res> {
  factory _$$BuddyEventImplCopyWith(
          _$BuddyEventImpl value, $Res Function(_$BuddyEventImpl) then) =
      __$$BuddyEventImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$BuddyEventImplCopyWithImpl<$Res>
    extends _$BuddyEventCopyWithImpl<$Res, _$BuddyEventImpl>
    implements _$$BuddyEventImplCopyWith<$Res> {
  __$$BuddyEventImplCopyWithImpl(
      _$BuddyEventImpl _value, $Res Function(_$BuddyEventImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$BuddyEventImpl implements _BuddyEvent {
  const _$BuddyEventImpl(
      {required this.id,
      required this.title,
  ...
  factory _$BuddyEventImpl.fromJson(Map<String, dynamic> json) =>
      _$$BuddyEventImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BuddyEventImplCopyWith<_$BuddyEventImpl> get copyWith =>
      __$$BuddyEventImplCopyWithImpl<_$BuddyEventImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BuddyEventImplToJson(
      this,
    );
  }
}

abstract class _BuddyEvent implements BuddyEvent {
  const factory _BuddyEvent(
      ...
      final double? eventParticipationCost}) = _$BuddyEventImpl;

  factory _BuddyEvent.fromJson(Map<String, dynamic> json) =
      _$BuddyEventImpl.fromJson;
