...
_$JoinedBuddyEventImpl _$$JoinedBuddyEventImplFromJson(
        Map<String, dynamic> json) =>
    _$JoinedBuddyEventImpl(
...
Map<String, dynamic> _$$JoinedBuddyEventImplToJson(
        _$JoinedBuddyEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
