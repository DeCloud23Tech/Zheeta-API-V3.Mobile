                    ...
                    decoration: InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: grey.withOpacity(0.5), width: 1.0),
                        ),
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: primaryDark, width: 1.0),
                        ),
                        border: const OutlineInputBorder(),
                        hintText: "Phone number",
                        hintStyle: TextStyle(
                            color: grey.withOpacity(0.5), fontSize: 14),
                      ...
                      if (_cpassword.text == _password.text)
                        UserService().register(
                            RegisterRequest(
                              ...
                              phoneCountryCode: _countryCode.text,
                              referralId: _referral.text,
                            ),
                            context);
                    },
                  )),
