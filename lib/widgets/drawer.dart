...
import 'package:zheeta/homepage/presentation/views/bank.dart';
import 'package:zheeta/homepage/presentation/views/giftshop.dart';
import 'package:zheeta/homepage/presentation/views/mygifts.dart';
import 'package:zheeta/homepage/presentation/views/pending.dart';
import 'package:zheeta/homepage/presentation/views/referees.dart';
                ...
                child: ListView(padding: EdgeInsets.zero, children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [for (var i = 0; i < 6; i++) community(context, "Community 1", "assets/images/comm.png", PendingRequests())],
                          ),
                        ),
                      ),
                    ],
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      menu(context, 'My Friend Request', "assets/images/icons/request.svg", PendingRequests()),
                      menu(context, 'Gift Shop', "assets/images/icons/shop.svg", GiftShop()),
                      menu(context, 'My Gifts', "assets/images/icons/gifts.svg", MyGifts()),
                      menu(context, 'Bank Account', "assets/images/icons/bank.svg", BankAccount()),
                      menu(context, 'Subscription Plan', "assets/images/icons/subscription.svg", () {}),
                      menu(context, 'My Referees', "assets/images/icons/referees.svg", Referees()),
                      menu(context, 'Nearby Users', "assets/images/icons/nearby.svg", () {})
                    ],
                  ),
                  SizedBox(height: 10),
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Z- \$ Rate in my Local Currency", style: TextStyle(color: darkText, fontSize: 14, fontWeight: FontWeight.w400)),
                        SizedBox(height: 10),
                        Container(
                          padding: EdgeInsets.all(10),
                          decoration: BoxDecoration(color: secondaryLight, borderRadius: BorderRadius.circular(8)),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("1 USD", style: TextStyle(color: darkText, fontSize: 16, fontWeight: FontWeight.w600)),
                              Container(
                                color: primaryDark,
                                height: 15,
                                width: 1,
                              ),
                              Text("740.00 NGN", style: TextStyle(color: darkText, fontSize: 16, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        )
                      ],
                  ...
                  SizedBox(
                    ...
                    child: PrimaryButton(
                        ...
                        action: () {
                          Scaffold.of(context).closeDrawer();
                          Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.rightToLeftWithFade, child: SignIn()));
                        }),
                  ),
                ]))));
  }
  ...
  GestureDetector menu(BuildContext context, String title, String icon, page) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [SvgPicture.asset(icon), SizedBox(height: 5), Text(title, style: TextStyle(color: darkText, fontSize: 14, fontWeight: FontWeight.w400))],
        ),
      ),
    );
  }

  GestureDetector community(BuildContext context, String title, String icon, page) {
    return GestureDetector(
      onTap: () {
        Scaffold.of(context).closeDrawer();
        Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeftWithFade, child: page));
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 5),
            Text(title, style: TextStyle(color: white, fontSize: 10, fontWeight: FontWeight.w400))
          ],
        ),
      ),
    );
