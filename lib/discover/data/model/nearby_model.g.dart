...
_$NearbyListDataModelImpl _$$NearbyListDataModelImplFromJson(
        Map<String, dynamic> json) =>
    _$NearbyListDataModelImpl(
      data: (json['data'] as List<dynamic>)
          .map((e) => NearbyDataModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$NearbyListDataModelImplToJson(
        _$NearbyListDataModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
