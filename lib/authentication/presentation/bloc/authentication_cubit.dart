  ...
  Future<void> registerUserCubit({required RegisterUserRequest request}) async {
    ...
    result.fold(
      ...
      (success) async {
        ...
        // // Step 2: Get Device Token and Platform
        ...
        // }
        //
        // final String platform = Platform.isIOS ? "APNS" : "FCM";
        //
        // // Step 3: Automatically Login User
        ...
        // await loginUserCubit(request: loginRequest);
      },
    );
  }
