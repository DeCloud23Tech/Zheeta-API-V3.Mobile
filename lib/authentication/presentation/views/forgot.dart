        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 32),
              SizedBox(width: double.infinity, child: PrimaryButton(title: 'Reset Password', action: () => showCupertinoDialog(barrierDismissible: true, context: context, builder: (context) => Modal(content: "We sent an email to christinedoe@company.com with link to reset your password", btn1Title: "Done", action: () => Navigator.pop(context)))))
            ],
          ),
        ),
      ),
