...
class _ProfileState extends State<Profile> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 40,
                      child: PrimaryButton(
                          invert: true, title: 'Boost Profile', action: () {}),
                    ),
                    SizedBox(height: 15),
                    Container(
                      height: 85,
  ...
  Container interest(title) {
    return Container(
        ...
        child: Text(title,
            style: TextStyle(
                color: grayscale, fontSize: 12, fontWeight: FontWeight.w400)));
  }
}
