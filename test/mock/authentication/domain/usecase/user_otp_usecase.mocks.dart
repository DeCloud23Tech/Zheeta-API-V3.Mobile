...
// in zheeta/test/mock/authentication/domain/usecase/user_otp_usecase.dart.
...
class MockUserOtpUseCase extends _i1.Mock implements _i2.UserOtpUseCase {
  ...
  @override
  dynamic sendEmailVerifyOtpUsecase(String? email) =>
      super.noSuchMethod(Invocation.method(
        #sendEmailVerifyOtpUsecase,
        [email],
      ));

  @override
  dynamic sendPhoneVerifyOtpUsecase(String? phoneNumber) =>
      super.noSuchMethod(Invocation.method(
        #sendPhoneVerifyOtpUsecase,
        [phoneNumber],
      ));

  @override
  dynamic verifyPhoneOtpUsecase(_i3.VerifyPhoneOtpRequest? request) =>
      super.noSuchMethod(Invocation.method(
  ...
  @override
  dynamic verifyEmailOtpUsecase(_i4.VerifyEmailOtpRequest? request) =>
      super.noSuchMethod(Invocation.method(
  ...
  @override
  dynamic resetPasswordUsecase(String? phoneNumber) =>
      super.noSuchMethod(Invocation.method(
