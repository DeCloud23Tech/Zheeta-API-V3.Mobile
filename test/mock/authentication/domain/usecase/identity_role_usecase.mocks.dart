...
// in zheeta/test/mock/authentication/domain/usecase/identity_role_usecase.dart.
...
class MockIdentityRoleUseCase extends _i1.Mock
  ...
  @override
  dynamic upgradeUserRoleUsecase(_i3.UserRoleRequest? request) =>
      super.noSuchMethod(Invocation.method(
        #upgradeUserRoleUsecase,
        [request],
      ));

  @override
  dynamic downgradeUserRoleUsecase(_i3.UserRoleRequest? request) =>
      super.noSuchMethod(Invocation.method(
        #downgradeUserRoleUsecase,
        [request],
      ));
}
